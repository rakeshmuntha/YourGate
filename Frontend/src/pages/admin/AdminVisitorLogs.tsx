  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-1 text-sm">All visitor activity in your community</p>
      </div>
      ...
      <div className="card overflow-hidden p-0">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 dark:border-[#2a2a2a]">
                ...
                <th className="text-left py-4 px-5 text-xs font-semibold text-gray-400 uppercase tracking-wider">Verified By</th>
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-[#1e1e1e]">
              {logs.map((log) => (
                <tr key={log._id} className="hover:bg-gray-50/50 dark:hover:bg-[#1e1e1e]/50 transition-colors">
                  ...
                  <td className="py-4 px-5 text-gray-400 text-xs">{typeof log.verifiedBy === 'object' ? log.verifiedBy.name : '—'}</td>
                  <td className="py-4 px-5 text-gray-400 text-xs">{new Date(log.entryTime).toLocaleString()}</td>
        ...
        {logs.length === 0 && (
          <div className="py-16 text-center">
            ...
            <p className="font-semibold text-gray-900 dark:text-white text-sm">No visitor logs</p>
