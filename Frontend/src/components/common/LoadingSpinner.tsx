const LoadingSpinner = ({
    ...
    if (variant === 'spinner') {
        ...
        // 276EF1 old spinner color the darker one is 0344bd
        return (
            <div className="flex items-center justify-center py-2">
                <div
                    className={`${sizeClass} border-[#E2E2E2] dark:border-[#2C2C2C] border-t-[#276EF1] dark:border-t-[#276EF1] rounded-full animate-spin`}
                />
            </div>
        );
    }
